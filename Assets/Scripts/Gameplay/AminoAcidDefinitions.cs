...
public static class AminoAcidDefinitions
{
    private static readonly Dictionary<string, AminoAcidData> dataMap = new Dictionary<string, AminoAcidData>
    {
        // 산성 아미노산
    ...
    {
        if (dataMap.TryGetValue(shortName, out AminoAcidData data))
        {
            return data;
        }
        return new AminoAcidData(shortName, shortName, "Unknown Skill", Color.white);
    }
}
